INSERT INTO product
(product_id, category_id, main_explanation, main_title, main_image, origin, origin_price, price, producer, product_main_explanation, product_sub_explanation, purchase_inquiry, image1, image2, image3, view_cnt, ea, status, seller_id, created_at, modified_at, `type`)
